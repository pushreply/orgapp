...
/**
 * PrivateInfoController - Handles the data for edit the private information of
 * the user
 * 
...
public class PrivateInfoController extends MenuActivity {
	// Required variables for progress dialog, calendar, new date fields, birthday
	// and gender
	...
	/**
	 * Initializes all necessary variables. Sets onClickListener for birthday
	 * calendar
	 * 
	...
	private DatePickerDialog.OnDateSetListener setDateListener = new DatePickerDialog.OnDateSetListener() {
		...
		/**
		 * Sets the birthday in the dialog selected by the user. Call
		 * updateBirthday()
		 * 
		...
		public void onDateSet(DatePicker view, int year, int month, int day) {
			...
			// User should see the checkbox "clear birthday" after the selection of a
			// birthday
	 ...
	 * 
	 * @return false, if one field contains the same data as previous. True
	 *         otherwise
	 */
	...
	class PrivateInfoUpdater extends AsyncTask<String, String, String> {
		...
		protected String doInBackground(String... arg0) {
			...
			// This value is not changeable in this layout, but required for the
			// update
