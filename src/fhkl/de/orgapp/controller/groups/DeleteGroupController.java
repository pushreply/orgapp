	...
	class GroupDelete extends AsyncTask<String, String, String>
	{
		...
		protected String doInBackground(String... params)
		{
			...
			try
			{
				...
				{
					notificationParams.add(new BasicNameValuePair("eMail", memberList.getJSONObject(m).getString(TAG_EMAIL).toString()));
					//send notification
			...
			{
				System.out.println("Error in DeleteGroupController.GroupDelete.doInBackground(String... params): " + e.getMessage());
				e.printStackTrace();
			}
