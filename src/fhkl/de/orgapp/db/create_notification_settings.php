...
$result = mysql_query ( "Insert into notificationSettings (personId, shownEntries, groupInvites, groupEdited,
			groupRemoved, eventsAdded, eventsEdited, eventsRemoved, commentsAdded, commentsEdited, commentsRemoved, privilegeGiven)
			values('$personId', 7, true, true, true, true, true, true, true, true, true, true)" ) or die ( mysql_error () );
if ($result) {
